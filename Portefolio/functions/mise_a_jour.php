...
<main>
    <section>
        ...
        <form action="index.php?action=update" method="post">
            ...
            <input type="text" id="nom" name="nom" value="<?= functions\htmlspecialchars($userInfo['nom']); ?>" required>
            <?php if (isset($data['errors']['nom'])) : ?>
                <p class="error-message"><?php echo $data['errors']['nom']; ?></p>
            <?php endif; ?>
            <label for="prenom">Prénom:</label>
            <input type="text" id="prenom" name="prenom" value="<?= functions\htmlspecialchars($userInfo['prenom']); ?>" required>
            <?php if (isset($data['errors']['prenom'])) : ?>
                <p class="error-message"><?php echo $data['errors']['prenom']; ?></p>
            <?php endif; ?>
            <label for="adresse">Adresse:</label>
            <input type="text" id="adresse" name="adresse" required value="<?= functions\htmlspecialchars($userInfo['adresse']); ?>" required>
            <?php if (isset($data['errors']['adresse'])) : ?>
                <p class="error-message"><?php echo $data['errors']['adresse']; ?></p>
            <?php endif; ?>
            <label for="email">Email:</label>
            <input type="email" id="email" name="email" value="<?= functions\htmlspecialchars($userInfo['email']); ?>" required>
